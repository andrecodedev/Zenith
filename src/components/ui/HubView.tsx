import { LayoutDashboard, Calendar, BarChart2, FileText, Landmark, PieChart, Music, Bot, Mic, ImageUpscale, AudioLines, Clapperboard } from 'lucide-react';
import { useStore } from '../../store/useStore';

export type AppView = 'hero' | 'sobre' | 'dashboard' | 'calendar' | 'stats' | 'notes' | 'finance' | 'investments' | 'hub' | 'music' | 'chat' | 'audio' | 'image_upscale' | 'voice_studio' | 'video_studio';
...
export function HubView({ onNavigate }: HubViewProps) {
  const options = [
    ...
    },
    {
      id: 'video_studio',
      title: 'Video Studio',
      description: 'Timeline multi-faixa e export MP4 para Tag Aberta',
